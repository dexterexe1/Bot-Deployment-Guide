...
import type { TicketPanel, Ticket } from '@/types/application'
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Ticket Panels</h2>
      ...
      {panels.length === 0 ? (
        <Card>
          <CardContent className="py-8 text-center text-muted-foreground">
            No ticket panels created yet. Create your first panel to get started.
          </CardContent>
        </Card>
      ) : (
            ...
            <Card key={panel.id} className="relative">
              ...
              <CardContent className="space-y-3">
                <div className="text-sm space-y-1">
                  ...
                  {panel.categoryName && (
                    <p className="text-muted-foreground">Category: {panel.categoryName}</p>
                  )}
                  <p className="text-muted-foreground">
                    Support Roles: {panel.supportRoleNames.join(', ') || 'None'}
                  </p>
                  <p className="text-muted-foreground">
                    Ticket Limit: {panel.ticketLimit ?? 'Unlimited'}
                  </p>
                </div>
